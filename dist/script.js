...
$.prototype.init = function (selector) {
  if (!selector) {
    return this; // this - пустой объект
  }
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.setAttr = function (id) {
  for (var _len = arguments.length, attribute = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.removeAttr = function (id) {
  for (let i = 0; i < this.length; i++) {
    this[i].removeAttribute(id);
  }
  return this;
};
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.toggleAttr = function () {
  for (let i = 0; i < this.length; i++) {
    this[i].toggleAttribute(...arguments);
  }
  return this;
};
...
(0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('button').setAttr('name', 'button');
})();
